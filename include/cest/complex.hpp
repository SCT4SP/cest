...
template <typename _Tp> struct complex {
  ...
  // _GLIBCXX_RESOLVE_LIB_DEFECTS
  // DR 387. std::complex over-encapsulated.
  _GLIBCXX20_CONSTEXPR void real(_Tp __val) { _M_real = __val; }

  _GLIBCXX20_CONSTEXPR void imag(_Tp __val) { _M_imag = __val; }
  ...
  _GLIBCXX_CONSTEXPR complex __rep() const { return *this; }
...
template <typename _Tp>
_GLIBCXX20_CONSTEXPR complex<_Tp> &complex<_Tp>::operator=(const _Tp &__t) {
  _M_real = __t;
  _M_imag = _Tp();
  return *this;
}
...
template <typename _Tp>
inline _GLIBCXX20_CONSTEXPR complex<_Tp> operator+(const complex<_Tp> &__x,
...
template <typename _Tp>
inline _GLIBCXX20_CONSTEXPR complex<_Tp> operator+(const _Tp &__x,
                                                   const complex<_Tp> &__y) {
  complex<_Tp> __r = __y;
  __r += __x;
  return __r;
...
template <typename _Tp>
inline _GLIBCXX_CONSTEXPR bool operator==(const complex<_Tp> &__x,
                                          const complex<_Tp> &__y) {
...
template <typename _Tp>
inline _GLIBCXX_CONSTEXPR bool operator==(const _Tp &__x,
                                          const complex<_Tp> &__y) {
...
// Values
#if __cplusplus >= 201103L
template <typename _Tp> constexpr _Tp real(const complex<_Tp> &__z) {
  return __z.real();
}

template <typename _Tp> constexpr _Tp imag(const complex<_Tp> &__z) {
  return __z.imag();
}
#else
template <typename _Tp> inline _Tp &real(complex<_Tp> &__z) {
  return __z.real();
}

template <typename _Tp> inline const _Tp &real(const complex<_Tp> &__z) {
  return __z.real();
}

template <typename _Tp> inline _Tp &imag(complex<_Tp> &__z) {
  return __z.imag();
}

template <typename _Tp> inline const _Tp &imag(const complex<_Tp> &__z) {
  return __z.imag();
}
#endif

// 26.2.7/3 abs(__z):  Returns the magnitude of __z.
template <typename _Tp> constexpr _Tp __complex_abs(const complex<_Tp> &__z) {
  _Tp __x = __z.real();
  _Tp __y = __z.imag();
...
template <typename _Tp> constexpr _Tp abs(const complex<_Tp> &__z) {
...
template <typename _Tp> inline _Tp __complex_arg(const complex<_Tp> &__z) {
...
template <typename _Tp> inline _Tp arg(const complex<_Tp> &__z) {
...
template <bool> struct _Norm_helper {
  template <typename _Tp>
...
template <typename _Tp>
inline _GLIBCXX20_CONSTEXPR _Tp norm(const complex<_Tp> &__z) {
...
template <typename _Tp>
inline _GLIBCXX20_CONSTEXPR complex<_Tp> conj(const complex<_Tp> &__z) {
...
template <typename _Tp> inline complex<_Tp> cos(const complex<_Tp> &__z) {
...
template <typename _Tp> inline complex<_Tp> cosh(const complex<_Tp> &__z) {
...
template <typename _Tp> inline complex<_Tp> exp(const complex<_Tp> &__z) {
...
template <typename _Tp> inline complex<_Tp> log(const complex<_Tp> &__z) {
...
template <typename _Tp> inline complex<_Tp> log10(const complex<_Tp> &__z) {
...
template <typename _Tp> inline complex<_Tp> sin(const complex<_Tp> &__z) {
...
template <typename _Tp> inline complex<_Tp> sinh(const complex<_Tp> &__z) {
...
template <typename _Tp> complex<_Tp> __complex_sqrt(const complex<_Tp> &__z) {
  ...
  if (__x == _Tp()) {
    ...
    _Tp __u = __t / 2;
    return __x > _Tp() ? complex<_Tp>(__u, __y / __t)
...
template <typename _Tp> inline complex<_Tp> sqrt(const complex<_Tp> &__z) {
...
template <typename _Tp> inline complex<_Tp> tan(const complex<_Tp> &__z) {
...
template <typename _Tp> inline complex<_Tp> tanh(const complex<_Tp> &__z) {
...
inline complex<_Tp> pow(const complex<_Tp> &__z, int __n) {
  return __n < 0 ? complex<_Tp>(1) /
                       cest::__complex_pow_unsigned(__z, -(unsigned)__n)
...
template <typename _Tp>
inline complex<_Tp> __complex_pow(const complex<_Tp> &__x,
                                  const complex<_Tp> &__y) {
  return __x == _Tp() ? _Tp() : std::exp(__y * std::log(__x));
}

#if _GLIBCXX_USE_C99_COMPLEX
inline __complex__ float __complex_pow(__complex__ float __x,
                                       __complex__ float __y) {
  return __builtin_cpowf(__x, __y);
}

inline __complex__ double __complex_pow(__complex__ double __x,
...
inline complex<_Tp> pow(const _Tp &__x, const complex<_Tp> &__y) {
  return __x > _Tp()
             ? cest::polar<_Tp>(pow(__x, __y.real()), __y.imag() * log(__x))
