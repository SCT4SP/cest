...
public:
  ...
  struct iter {
    ...
    friend difference_type constexpr operator-(const iter &__x,
                                               const iter &__y) noexcept {
      return CHUNK_SIZE * (__x.m_ppchunk - __x.m_ppchunk - 1) +
             (__x.m_p - *__x.m_ppchunk) +
  ...
  struct const_iter {
    ...
    friend difference_type constexpr operator-(const const_iter &__x,
                                               const const_iter &__y) noexcept {
      return CHUNK_SIZE * (__x.m_ppchunk - __x.m_ppchunk - 1) +
             (__x.m_p - *__x.m_ppchunk) +
             (*__y.m_ppchunk + CHUNK_SIZE - __y.m_p);
    }
  ...
  constexpr reference front() { return m_chunks[m_front_chunk][m_front]; }
  constexpr const_reference front() const {
    return m_chunks[m_front_chunk][m_front];
  }
  constexpr reference back() { return m_chunks[m_back_chunk][m_back]; }
