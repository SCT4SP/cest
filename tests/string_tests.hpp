...
template <typename S> constexpr bool string_test1() {
  S str;
  bool b1 = str.empty();
  ...
  return b1 && b2 && s1 == 0 && b3 && s2 == 1 && q == 'q' && nt0 == '\0' &&
         nt1 == '\0';
}

template <typename S> constexpr bool string_test2() {
  S str("Ok");
  ...
  bool b1 =
      2 == str.size() && 2 == str.length() && 'O' == str[0] && 'k' == str[1];
  bool b2 = '\0' == nt && '\0' == nt2 && eq && '!' == c;
  return b1 && b2;
}

template <typename S> constexpr bool string_test3() {
...
template <typename S> constexpr bool string_test4() {
  S str("abcde,abcde");
  S cd("cd"), xxx("xxx");
  S one_dollar("$1");
...
template <typename S> constexpr bool string_test5() {
  S str0("");
...
template <typename S> constexpr bool string_test7() {
  S str("Zod");
  S str2(str);
  str += '!';
  return str != str2;
...
template <typename S> constexpr bool string_test8() {
  S str1("Hello\0 World");
  S str2("Hello\0 World", 12);
  return str1.length() != str2.length();
}

template <typename S> constexpr bool string_test9() {
  S str1("abc");
  S str2("abcd");
...
template <typename S> constexpr bool string_test10() {
  S str("abc"), str2;
